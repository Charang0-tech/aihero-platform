// Week 21 Monday Enhanced Content
// Week 21 Monday: REST APIs - Theory & Concepts

import { LessonContent } from '../../../types';

export const mondayContent: LessonContent = {
  learn: {
    objective: "Master rest apis through theory & concepts",
    sections: [
      {
        title: "REST APIs Fundamentals",
        content: `
# REST APIs - Monday Focus

Welcome to Week 21 Monday: REST APIs - Theory & Concepts! Today we'll focus on monday aspects of rest apis.
...
[CONTENT TO BE ADDED - Detailed explanation of concepts]
        ...
        codeExample: {
          ...
          code: `# Week 21 Monday: REST APIs - Theory & Concepts
# TODO: Add comprehensive code example

print("Welcome to Week 21 Monday: REST APIs - Theory & Concepts!")
    ...
    exercises: [
      {
        ...
        difficulty: "beginner",
        codeTemplate: `# Week 21 Monday: REST APIs - Theory & Concepts Practice
...
`,
    ...
    miniProject: {
      ...
      starterCode: `# Week 21 Monday: REST APIs - Theory & Concepts Mini Project
    ...
    tasks: [
      {
        ...
        code: `# Week 21 Monday: REST APIs - Theory & Concepts Lab
